...
tmp = tempfile()
download.file(url = "https://www.ebi.ac.uk/biostudies/files/S-BIAD1283/Biostudies_files/Animal_Testing_Eval_feature_importance_per_context.csv", destfile = tmp)
